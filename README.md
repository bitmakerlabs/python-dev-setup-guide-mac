...
To install ruby 2.1.2 (substitute this for the latest recommended version of ruby indicated on the [Rails website](http://rubyonrails.org/download)):
```
rbenv install 2.1.2
```
